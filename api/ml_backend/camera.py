...
class Detect():
    def __init__(self):
        self.detection_model_path = 'ml_backend/models/haarcascade_frontalface_default.xml'
        self.emotion_model_path = 'ml_backend/models/_mini_XCEPTION.102-0.66.hdf5'
    ...
    def get_face_detector(self,modelFile=None,
                        configFile=None,
                        quantized=False):
        if quantized:
            if modelFile == None:
            ...
            if modelFile == None:
                modelFile = join(dirname(__file__), "models/res10_300x300_ssd_iter_140000.caffemodel") #join(dirname(__file__), )
            # = "res10_300x300_ssd_iter_140000.caffemodel"
            if configFile == None:
                configFile =join(dirname(__file__), "models/deploy.prototxt")    #join(dirname(__file__),)
    ...
    def get_frame(self,ig):
        ...
        if rects!=[] and cmt == 0:
            ...
            cv2.putText(img, 'face not found', (30, 30), self.font,
                        1, (0, 255, 255), 2)
        ...
        if True:
            ...
            if len(faces)==0:
                cv2.putText(img, "Please Focus on the class", (30, 30), self.font,
                        1, (0, 255, 255), 2)
                O = O + 1
                if O >= 20:
                    toll = toll - 1
            ...
            for face in faces:
                ...
                if cnt_outer > 3 and cnt_inner > 2:
                    ...
                    cv2.putText(img, 'Mouth open', (30, 30), self.font,
                                1, (0, 255, 255), 2)
                ...
                (success, rotation_vector, translation_vector) = cv2.solvePnP(self.model_points, image_points, self.camera_matrix,
               ...
               # cv2.line(img, tuple(x1), tuple(x2), (255, 255, 0), 2)
                ...
                if ang1 >= 40:
                    ...
                    cv2.putText(img, 'Head down', (30, 30), self.font, 2, (255, 255, 128), 3)
                    ...
                    cv2.putText(img, 'Head up', (30, 30), self.font, 2, (255, 255, 128), 3)

                if ang2 >= 40:
                    hrl.append("Head Right")
                    cv2.putText(img, 'Head right', (90, 30), self.font, 2, (255, 255, 128), 3)
                elif ang2 <= -40:
                    hll.append("Head left")
                    cv2.putText(img, 'Head left', (90, 30), self.font, 2, (255, 255, 128), 3)
        ...
        a={"mouth":len(Ml),"head_up":len(hul),"head_dwn":len(hdl),"head_left":len(hll),"head_right":len(hrl),"out":len(out),"tot":toll,"emo":emm}
        #print(a)
